 ...
 */
  ...
  #else
    #define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 200*16/4, 415}  /* Raise3D stock extruder(s) */
  #endif
#endif
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 9000, 9000, 100, 10000, 10000 }  /* Raise3D defaults */
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -.25  // Z offset: -below +above  [the nozzle]    /* Raise3D BLTouch */ MIGHT TRY -.30 / Adjust with Gcode
...
// Preheat Constants /*Raise3D can be change on the touch screen/8
 ...
 */
#define NOZZLE_PARK_FEATURE // Raise3D FOS
